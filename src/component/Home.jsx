...
const Home = () => {
  return (
    <div className="flex relative p-0 m-0 box-border  ">
      <div
        className=" bg-cover bg-center  w-[486px] h-[screen] rotate-0 relative " //mr-10
      ...
      >
        ...
        <div className="h-full flex items-center justify-center absolute right-[-200px] top-[50px] w-[500px] ">
          <div className="absolute  right-[-100px]  max-w-[1000px] mx-1 px-8  flex flex-col justify-center h-full ">
            ...
            <p className="text-[#8892b0] pt-3 max-w-[700px] border-">
      ...
      <div
        className=" h-screen bg-cover bg-center w-[75%] ml-0 pl-0 " //ml=10
